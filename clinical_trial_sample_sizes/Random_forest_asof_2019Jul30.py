...
output_dir = 'random_forest_' + num_years + '_years_' + covariate_set_name + '_2019Jul30_testset_fixed/'
...
for outcome in outcomes:
    ...
    for fold_idx in range(4):
        ...
        for min_samples_leaf in min_samples_leaf_choices:
            random_forest = RandomForestClassifier(n_estimators=10, min_samples_leaf=min_samples_leaf, random_state=0)
    ...
    coef_ax.set_xlabel('Random forest feature importances')
